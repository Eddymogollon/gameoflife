...
var ControlButtons = React.createClass({
  ...
  render: function render() {
    return (
      <div className="btn-group btn-group-sm text-left" role="group" aria-label="start | pause | clear ">
    ...
    return (
      <div className="container-fluid">
        ...
        <div className="row col-lg-6 col-lg-offset-3 col-md-offset-2 col-sm-offset-1 text-center">
          ...
          <p id="footerText">Check this project on <a href="https://github.com/Eddymogollon/URL-shortener">GitHub</a>!</p>
